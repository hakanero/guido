...
DEPRECATED
backend.py
written during the HackHarvard Hackathon 2025
by Rudransh Agrawal, Coleman Hayes

Tests AI loop for generating audio tours of locations.
"""
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            base_prompt = (
                f"You are a historian. Provide a detailed history of the area immediately surrounding"
                + location
                + "within about 50 feet. Begin with Indigenous use of the land, then colonial settlement, industrialization, institutional growth, and modern developments. Focus on specific changes to the land, buildings, and community. Present the answer as a chronological timeline followed by a short narrative description. It should take approximately 2 minutes to read aloud, and do not mention any of the prompting given"
            )
            ...
            if same_place_loop == 1:
                ...
                question2 = (
                    base_prompt
                    + " You already mentioned the following facts, do not repeat yourself: "
                    + answer1
                )
                ...
                if same_place_loop >= 3:
                    question3 = (
                        base_prompt
                        + " Focus on a description of present day uses, and do not mention the following facts, do not repeat yourself: "
                        + answer1
                        + " "
                        + answer2
                    )
